...
public final class ProjectCreationWizard extends AbstractProjectWizard implements INewWizard {
     ...
     */
    private static final String PROJECT_CREATION_DIALOG_SETTINGS = "org.eclipse.buildship.ui.internal.wizard.project.creation"; //$NON-NLS-1$

    /**
     * Preference key that flags whether the welcome page should be shown as part of the creation wizard.
     */
    private static final String PREF_SHOW_WELCOME_PAGE = "org.eclipse.buildship.ui.internal.wizard.project.creation.showWelcomePage"; //$NON-NLS-1$
